...
model_path = r"C:\porJ_\WEB-Cow-main\templates\modelXGBoost.pkl"
if os.path.exists(model_path):
    ml_model = joblib.load(model_path)
else:
    raise FileNotFoundError(f"❌ Model file '{model_path}' not found!")

model_path_forDL = r"C:\porJ_\WEB-Cow-main\templates\modelXGBoost_forDL.pkl"
...
yolo_model_path = r"C:\porJ_\WEB-Cow-main\templates\yolov8s-seg.pt"
